...
const Notification = (message) => {
  return (
    <div>
      <p style={notificationStyle}>{message.message}</p>
    </div>
  )
}
...
const About = () => (
  <Grid>
    <div class="ui grid">
      ...
      <img src="https://pbs.twimg.com/profile_images/1152859879/kuva_400x400.jpg" />
      </div>
    </div>
  </Grid>
)
...
class App extends React.Component {
  ...
  addNew = (anecdote) => {
    ...
    this.setState({
      ...
      notification: `You created a new anecdote "${anecdote.content}"`
    })
    setTimeout(() => {
      this.setState({
        notification: ''
